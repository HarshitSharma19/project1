...
export default function BrandList({name , logo , sno, status , homepage}) {
  return (
    <>
        ...
        <table className="table-auto text-center w-full ">
          ...
          <tbody>
            <tr className='border-b'>
              <td>{sno}</td>
              <td>{name}</td>
              <td className='flex justify-center items-center'><img src={logo} alt="" width="120px" /></td>
              <td><SwitchBtn flag={status} /></td>
              <td><HomeBtn home={homepage}/></td>
              <td>Apple</td>
