...
export default function AddCategory() {
  ...
  const formHandler = (event) => {
    ...
    axios.post("http://localhost:4000/admin-panel/category/add",
      {
        "name": name,
        "image": img
      },
  ...
  return (
    ...
    <>
      <div className=' flex border-b-2 justify-between px-4 py-2'>
          <div className=' h-14 text-2xl flex items-center justify-center text-gray-700 '> Add Category</div>
        </div>
            ...
            <table className='table-auto w-full '>
              <tbody>
                ...
                <tr className='h-26 border-b-2'>
                  <td className='flex items-start mt-4'>Image</td>
