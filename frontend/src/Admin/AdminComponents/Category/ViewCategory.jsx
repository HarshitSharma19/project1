...
export default function ViewCategory() {
  ...
  const Data = data.map((a, i)=>{
    return <CategoryList id={a._id}  created={a.created_at} status={a.status} key={i} sno={i} name={a.name} image={a.image}/>
  })
  ...
  return (
    ...
    <div className='flex border-b-2 justify-between px-4 py-2  ' >
        <div className=' h-14 text-2xl flex items-center justify-center text-gray-700'> View Category</div>
        <div className='pt-1'>
