        ...
        <Disclosure as="div" className="mt-2">
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-2 pb-1 text-gray-700">
                  <Link to='/admin-panel/rating/add'><button className='flex w-48  rounded-md py-1 pl-2 text-left text-base hover:bg-slate-200'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg> Add
                  </button></Link>
              ...
              <Disclosure.Panel className="px-4 pt-2 pb-2 text-gray-700">
                 <Link to='/admin-panel/rating/view'><button className='flex w-48 rounded-md py-1 pl-2 text-left   text-base hover:bg-slate-200'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mt-1 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 10h16M4 14h16M4 18h16" />
                    </svg>View
                  </button></Link>
