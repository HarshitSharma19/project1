...
function FooterBox(){
    return(
        <>
<Link to="#" class="block p-6 max-w-sm bg-white rounded-lg border  shadow-md">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-black">Follow Us
        </h5>
