    ...
    <Container>
      ...
      <div className=' black md:bg-none flex justify-between md:hidden items-center h-24 max-w-[1240px] mx-auto px-4 text-b'>
        ...
        <ul className={
          ...
          <li className='p-5 text-lg font-bold border-b hover:font-bold  hover:-translate-y-1 hover:scale-110 duration-300 border-black'>HOME</li>
          <li className='p-5 text-lg font-bold border-b hover:font-bold  hover:-translate-y-1 hover:scale-110 duration-300 border-black'>OFFER</li>
          <li className='p-5 text-lg font-bold border-b hover:font-bold  hover:-translate-y-1 hover:scale-110 duration-300 border-black'><NavDropdown/></li>
        </ul>
      </div>
