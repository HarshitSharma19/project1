  ...
  <Container>
    <div className='h-80 flex  justify-between' style={{ width: "90%",height:"400px", margin: " auto " }}>
      <div className='text-center flex flex-col justify-center '>
        ...
        <button
          className="bg-white hover:bg-gray-100   md:text-gray-800 font-semibold my-10 mx-52 py-2 px-1 border border-b-2 rounded shadow">
          Shop Now
        </button>
      </div>
...
// <div className='bg-blue-600 w-1920 h-400 flex  '>
  ...
  // <div className=' '>
    // <div className='my-20'>
      ...
      // <button
       // className="bg-white hover:bg-gray-100 text-gray-800 font-semibold my-10 mx-52 py-2 px-1 border border- b-2 rounded shadow">
        // Shop Now
        // </button>
      // </div>
    // <div>
